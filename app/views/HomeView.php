<div class="container mx-auto px-10 py-6">
  <div class="flex w-full justify-between select-none items-center">
    <div
      class="text-center rounded-full shadow-inner bg-gradient-to-r from-green-500 via-green-700 to-green-900 py-3 px-3.5"
    >
    ...
    <div class="justify-end flex items-center">
      <div class="text-center">
        <a
          href="#"
          class="text-green-600 rounded-md p-4 text-xl font-mono font-bold uppercase hover:bg-green-600 hover:text-white transition-all duration-500"
          >Subscribe</a
        >
      </div>
      <div class="text-center ml-4">
        <a
          href="#"
          class="text-green-600 p-4 rounded-md text-xl font-mono font-bold uppercase hover:bg-green-600 hover:text-white transition-all duration-500"
          >Sign Up</a
        >
      </div>
    </div>
  ...
  <div
    class="container flex items-center mt-6 py-2 overflow-x-auto scrollbar select-none h-20"
  >
    <div
      class="whitespace-nowrap text-center text-2xl text-gray-800 font-medium"
    >
      <a
        href="#"
        class="p-4 text-center align-middle hover:text-green-500 transition-all"
        >World</a
      >
      <a
        href="#"
  ...
  <div class="container mt-10">
    <div
      class="w-full bg-green-400 rounded-3xl text-white shadow-xl px-16 py-16"
    >
      <div class="container">
        <h1 class="text-4xl mb-6 font-bold">Apple M1</h1>
        <p class="text-2xl mt-2 font-semibold">
          Apple M1 — система на кристалле ARM-архитектуры компании Apple из
          серии Apple Silicon, используемая в компьютерах Mac и ноутбуках
          MacBook. Первыми устройствами на M1 стали MacBook Pro 2020, MacBook
          Air 2020 и Mac Mini 2020. Процессор производится контрактным
          производителем TSMC на 5-нанометровом техпроцессе.
        </p>
      </div>
  ...
  <div class="container w-full h-full my-16">
    <div
      class="flex w-full h-full items-center justify-between flex-col sm:flex-col md:flex-col lg:flex-col xl:flex-row"
    >
      <div
        class="container flex-1 flex-nowrap p-10 mt-10 md:mt-10 lg:mt-10 xl:mt-0 lg:mr-0 xl:mr-5 bg-gray-50 rounded-3xl shadow-xl hover:text-white hover:bg-gray-900 transition-all duration-1000 hover:cursor-pointer"
      >
        <div class="flex justify-between mb-3">
          <h3
            class="font-bold text-red-600 italic text-2xl uppercase font-mono"
          >
            U.S.
          </h3>
      ...
      <div
        class="container flex-1 flex-nowrap mt-10 md:mt-10 lg:mt-10 xl:mt-0 lg:ml-0 xl:ml-5 p-10 bg-gray-50 rounded-3xl shadow-xl hover:text-white hover:bg-gray-900 transition-all duration-1000 hover:cursor-pointer"
      >
        <div class="flex justify-between mb-3">
          <h3
            class="font-bold text-green-600 italic text-2xl uppercase font-mono"
          >
            Design
          </h3>
          <h5 class="font-semibold text-2xl text-green-400 text-right">
  ...
  <div class="container mt-10">
    ...
    <div class="container bg-blue-500 shadow-xl rounded-lg p-6 mt-10 px-12">
      <div class="container mt-10">
        <div
          class="flex flex-col sm:flex-col md:flex-col lg:flex-row xl:flex-row justify-between font-bold text-white items-start sm:items-start md:items-start lg:items-center xl:items-center lg:text-center xl:text-center"
        >
          <h3
            class="text-3xl sm:text-3xl md:text-3xl lg:text-3xl xl:text-4xl font-extrabold"
          >
        ...
        <div class="flex justify-between items-center mt-10">
          <div>
            <a
              href="#"
              class="inline-flex items-center hover:bg-gray-900 rounded-full transition-all duration-500 hover:shadow-md h-12 pr-6"
            >
              <img
                src="./app/images/author.jpg"
  ...
  <div class="container mt-20 border-t-2">
    <div class="flex justify-between items-center mt-4">
      ...
      <div class="flex">
        <a
          href="https://github.com/Jarvis-Technologies/JarvisBlog"
          target="_blank"
        ...
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            class="h-12 text-gray-600 stroke-current"
            viewBox="0 0 24 24"
            stroke="#fff"
          >
            <path
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="current"
            class="h-12 fill-current text-red-600 stroke-current"
            viewBox="0 0 24 24"
            stroke="current"
          >
            <path
          ...
          <span
            class="ml-2 font-bold bg-gray-900 rounded-lg py-2 px-4 font-mono uppercase text-white text-xl"
            >Jarvis-Technologies</span
          >
        </a>
      </div>
    </div>
